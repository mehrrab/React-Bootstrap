...
const Footer = () => {
  ...
  <li class="icon-content">
    ...
    <div class="tooltip">Telegram</div>
        ...
        <Row className="text-center  p-3 gy-2 ">
          <Col sm={12} md={12}>
           &copy;Copyright <span className="fw-bold">Knight .</span> All Rights Reserved
          </Col>
          <Col sm={12} md={12}>
          Designed by <a className='linkRGB' href="Altar.computer@gmail.com">Mehrab Shakerpour</a>
          </Col>
        </Row>
      </Container>
    </>
